...
| Worker     | `backend/src/worker.ts`                                                 | Plans every campaign every fifteen minutes and on demand, sends one message at a time, purges old logs daily, writes a heartbeat every five minutes. |
